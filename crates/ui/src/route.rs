...
mod tests {
    ...
    #[test]
    fn deck_hashes_route_to_the_deck_editor() {
        assert_eq!(
            route_from_hash("#/decks/talk-candidate-1"),
            View::Deck("talk-candidate-1".to_owned())
        );
        assert_eq!(hash_for(&View::Deck("talk".to_owned())), "#/decks/talk");
    }
    ...
    #[test]
    fn print_hashes_route_to_the_print_editor() {
        assert_eq!(
            route_from_hash("#/prints/poster-candidate-1"),
    ...
    #[test]
    fn campaign_hashes_route_to_the_campaign_editor() {
        assert_eq!(
            route_from_hash("#/campaigns/launch-candidate-1"),
            View::Campaign("launch-candidate-1".to_owned())
        );
        assert_eq!(
            hash_for(&View::Campaign("launch".to_owned())),
            "#/campaigns/launch"
        );
    }
